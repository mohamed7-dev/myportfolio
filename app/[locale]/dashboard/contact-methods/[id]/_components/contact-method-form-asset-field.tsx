...
import type { ContactMethodAsset } from "@/lib/dto/contact-method";
...
interface ContactMethodFormAssetFieldProps {
  contactMethodAssets: ContactMethodAsset[];
  featuredAsset?: Asset;
}

export function ContactMethodFormAssetField({
  contactMethodAssets,
  featuredAsset,
