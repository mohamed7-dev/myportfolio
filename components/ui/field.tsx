...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: shadcn way of handling a11y
    <div
      role="group"
      data-slot="field"
  ...
  const content = useMemo(() => {
    ...
    return (
      <ul className="ms-4 flex list-disc flex-col gap-1">
        {uniqueErrors.map(
          (error, index) =>
            // biome-ignore lint/suspicious/noArrayIndexKey: errors don't have unique identifier other than index
