  ...
  const editor = useEditor(
    {
      ...
      editorProps: {
        attributes: {
          class: `rich-text-editor placeholder:text-foreground field-sizing-content min-h-16 w-full bg-transparent px-3 py-2 text-base transition-[color,box-shadow] outline-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm max-h-[500px] overflow-y-auto ${disabled ? "cursor-not-allowed opacity-50" : ""}`,
        },
      },
    },
    [extensions],
